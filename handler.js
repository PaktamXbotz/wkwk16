                    ...
                    for (let user of participants) {
                       let pp = './src/welcome.jpg'
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Selamat Datang, Kak ').replace('@subject', groupMetadata.subject).replace('@desc', groupMetadata.desc.toString()) :
